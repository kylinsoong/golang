...
func (ag *agentAS3) Deploy(req interface{}) error {
	...
	log.Debugf("[TEST] --> Sent message to channel %v, ReqID: %d, MsgType: %s, ResourceRequest: %v", ag.ReqChan, msgReq.ReqID, msgReq.MsgType, msgReq.ResourceRequest.AgentCfgmaps)
	return nil
}
